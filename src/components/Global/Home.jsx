  ...
  return (
    <div className="home-container">
      ...
      >
        <SplideSlide>
          <img
            className="cover_image slide"
            src={require("../../img/gym1.jpg")}
            alt=""
          />
        </SplideSlide>
        <SplideSlide>
      ...
      <div className="flex-container content_area">
        <div className="gym_area">
          <div className="gym_area_title">注目のジム</div>
          {[...gyms].map((gym) => (
            <div
            ...
            >
              ...
              <div className="gym_content">
                ...
                <div className="gym_address">
                  <span className="address-svg-icon">
                    <HiMapPin size={20} />
                  </span>
                  <span>
                    {gym.address
                ...
                <div className="gym_detail">
                  <span className="gym-detail-svg-icon">
        ...
        <div className="post_area">
          <div className="post_area_title">投稿</div>
          {[...posts].map((post) => (
